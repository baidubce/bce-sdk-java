...
/**
 * alarm video info by vehicleId list request
 *
 * @Author: shihuike
 * @Date: Created in 2019-08-01 16:45
 */
public class AlarmVideoInfoByVehicleIdListRequest extends AbstractDuGoRequest {
