...
public class EniUpdateSecurityGroupRequest extends EniOperateRequest {
    ...
    /**
     * A list of common security group ids
     */
    private List<String> securityGroupIds;

    @Builder(builderMethodName = "EniUpdateSecurityGroupRequestBuilder")
    public EniUpdateSecurityGroupRequest(String clientToken, String action, String eniId,
