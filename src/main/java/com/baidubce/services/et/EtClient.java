...
public class EtClient extends AbstractBceClient {
    ...
    /**
     * Associate an extra channel to the ET channel.
     *
     * @param request The request containing all options for associating an extra channel to the ET channel.
     */
    public void associateEtChannel(AssociateEtChannelRequest request) {
        checkNotNull(request, "request should not be null.");
        checkStringNotEmpty(request.getEtId(), "etId should not be empty");
        checkStringNotEmpty(request.getEtChannelId(), "etChannelId should not be empty");
        checkStringNotEmpty(request.getExtraChannelId(), "extraChannelId should not be empty");

        InternalRequest internalRequest = this.createRequest(request, HttpMethodName.PUT, ET_PREFIX, request.getEtId(),
                ET_CHANNEL_PREFIX, request.getEtChannelId());
    ...
    /**
     * Disassociate an extra channel from the ET channel.
     *
     * @param request The request containing all options for disassociating an extra channel from the ET channel.
     */
