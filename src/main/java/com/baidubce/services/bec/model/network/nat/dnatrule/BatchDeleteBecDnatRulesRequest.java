 ...
 * @Version v1.0
 * <p>
 * The request for deleting batch D-NAT rules.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BatchDeleteBecDnatRulesRequest extends AbstractBceRequest {
     ...
     */
    public BatchDeleteBecDnatRulesRequest withRequestCredentials(BceCredentials credentials) {
