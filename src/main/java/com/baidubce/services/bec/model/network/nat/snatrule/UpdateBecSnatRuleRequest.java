 ...
 * @Version v1.0
 * <p>
 * The request for updating S-NAT rule.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class UpdateBecSnatRuleRequest extends AbstractBceRequest {
     ...
     */
    public UpdateBecSnatRuleRequest withRequestCredentials(BceCredentials credentials) {
