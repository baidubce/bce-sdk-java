 ...
 * @Version v1.0
 * <p>
 * The request for creating S-NAT rule.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CreateBecSnatRuleRequest extends AbstractBceRequest {
     ...
     */
    public CreateBecSnatRuleRequest withRequestCredentials(BceCredentials credentials) {
