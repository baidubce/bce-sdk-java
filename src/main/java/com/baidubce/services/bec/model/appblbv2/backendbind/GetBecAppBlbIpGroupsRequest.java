 ...
 * @Version v1.0
 * <p>
 * The request for getting app blb ip group.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class GetBecAppBlbIpGroupsRequest extends AbstractBceRequest {
     ...
     */
    public GetBecAppBlbIpGroupsRequest withRequestCredentials(BceCredentials credentials) {
