...
/**
 * The request for deleting the Pod/Vm bound to the specified BLB backend.
 */
@Data
public class DeleteBecBlbBindPodRequest extends AbstractBceRequest {
     ...
     */
    public DeleteBecBlbBindPodRequest withRequestCredentials(BceCredentials credentials) {
