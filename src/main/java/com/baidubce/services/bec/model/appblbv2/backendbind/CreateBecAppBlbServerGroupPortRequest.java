 ...
 * @Version v1.0
 * the request for creating app blb server group port
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CreateBecAppBlbServerGroupPortRequest extends AbstractBceRequest {
     ...
     */
    public CreateBecAppBlbServerGroupPortRequest withRequestCredentials(BceCredentials credentials) {
