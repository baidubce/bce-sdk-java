 ...
 * @Version v1.0
 * <p>
 * The request for creating app blb ip group policy.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CreateBecAppBlbIpGroupBackendPolicyRequest extends AbstractBceRequest {
     ...
     */
    public CreateBecAppBlbIpGroupBackendPolicyRequest withRequestCredentials(BceCredentials credentials) {
