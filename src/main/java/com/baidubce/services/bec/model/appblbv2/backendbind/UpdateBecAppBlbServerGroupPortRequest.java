 ...
 * @Version v1.0
 * the request for updating app blb server group port
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class UpdateBecAppBlbServerGroupPortRequest extends AbstractBceRequest {
     ...
     */
    public UpdateBecAppBlbServerGroupPortRequest withRequestCredentials(BceCredentials credentials) {
