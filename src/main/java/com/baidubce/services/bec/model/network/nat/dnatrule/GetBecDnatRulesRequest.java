 ...
 * @Version v1.0
 * <p>
 * The request for getting D-NAT rules.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class GetBecDnatRulesRequest extends AbstractBceRequest {
     ...
     */
    public GetBecDnatRulesRequest withRequestCredentials(BceCredentials credentials) {
