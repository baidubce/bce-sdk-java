...
import com.baidubce.services.bec.model.vo.DnatRuleVo;
 ...
 * @Version v1.0
 * <p>
 * The responsefor getting D-NAT rules.
 */
@Data
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class GetBecDnatRulesResponse extends LogicPageResultResponse<DnatRuleVo> {
}