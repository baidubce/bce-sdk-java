 ...
 * @Version v1.0
 * <p>
 * The request for deleting batch nats.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BatchDeleteBecNatsRequest extends AbstractBceRequest {
     ...
     */
    public BatchDeleteBecNatsRequest withRequestCredentials(BceCredentials credentials) {
