 ...
 */
public class ResizeVolumeClusterRequest extends AbstractBceRequest {
    /**
    ...
    private int newClusterSizeInGB;
    ...
    public int getNewClusterSizeInGB() {
        return newClusterSizeInGB;
    }

    public void setNewClusterSizeInGB(int newClusterSizeInGB) {
     ...
     */
    @Override
    public ResizeVolumeClusterRequest withRequestCredentials(BceCredentials credentials) {
