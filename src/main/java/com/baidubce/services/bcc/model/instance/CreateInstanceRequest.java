...
public class CreateInstanceRequest extends AbstractBceRequest {
    ...
    /**
     * Indicates whether to enable the delete protection for the instance.
     */
    ...
    /**
     * Specified the short ids of eni of creating instance, optional param.
     * Only createInstanceBySpec interface support eniIds.
     */
    ...
    private boolean enableJumboFrame = false;
    ...
    public CreateInstanceRequest withKeepImageLogin(boolean keepImageLogin) {
    ...
    /**
     * Configure the eniIds for the request.
     * Only createInstanceBySpec interface support eniIds.
     * @param eniIds The specified eni short ids.
     * @return CreateInstanceRequest with specified eniIds
     */
    public CreateInstanceRequest withEniIds(List<String> eniIds) {
        this.setEniIds(eniIds);
        return this;
    }
    ...
    public CreateInstanceRequest withEhcClusterId(String ehcClusterId) {
        this.setEhcClusterId(ehcClusterId);
        return this;
    }
