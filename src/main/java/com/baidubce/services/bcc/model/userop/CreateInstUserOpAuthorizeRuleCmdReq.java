...
public class CreateInstUserOpAuthorizeRuleCmdReq extends AbstractBceRequest {
    /**
     * Do you want to enable preAuthorization immediately
     */
    ...
    public String toString() {
        return "CreateInstUserOpAuthorizeRuleCmdReq{"
    ...
    @Override
    public CreateInstUserOpAuthorizeRuleCmdReq withRequestCredentials(BceCredentials credentials) {
