...
public class UnbindTagsRequest extends AbstractBceRequest {
    ...
    /**
     * The list of tags to be unbound.
     */
    private List<TagModel> changeTags;

    /**
     * Whether to unbind the tags attached to related resources.
     */
     ...
     * @return UnbindTagsRequest with specified list of tags to be unbound.
     */
     ...
     *
     * @param instanceId The id of instance which will be used to unbind a list of tags.
     * @return UnbindTagsRequest with specified instance id.
     */
     ...
     * @return UnbindTagsRequest with credentials.
     */
    @Override
