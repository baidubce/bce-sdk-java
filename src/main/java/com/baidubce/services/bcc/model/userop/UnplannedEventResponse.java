...
public class UnplannedEventResponse {
    ...
    /**
     * Faulty Disk Information List
     */
    private List<IssueDiskInfoResponse> issueDiskInfos;

    public List<IssueDiskInfoResponse> getIssueDiskInfos() {
        return issueDiskInfos;
    }

    public void setIssueDiskInfos(List<IssueDiskInfoResponse> issueDiskInfos) {
    ...
    public void setFailures(List<IssueResponse> failures) {
