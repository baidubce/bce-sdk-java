 ...
 */
public class DeleteFunctionRequest extends AbstractBceRequest {
    /**
     * The function name. You can specify a function name (for example, Thumbnail), or you can specify the BRN resource
     * name of the function (such as brn:bce:cfc:bj:account-id:function:thumbnail:$LATEST).
     * CFC also allows you to specify a partial BRN (for example, account-id:Thumbnail). Note that the BRN length is
     * limited to 1-170. If only the function name is specified, the length is limited to 64 characters.
     */
     ...
     */
    @Override
    public DeleteFunctionRequest withRequestCredentials(BceCredentials credentials) {
