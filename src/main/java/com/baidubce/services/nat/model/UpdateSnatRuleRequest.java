...
/**
 * The request for updating one snat rule in the specified snat.
 */
@Getter
@Setter
public class UpdateSnatRuleRequest extends AbstractBceRequest {
    ...
    /**
     * The id of the snat rule to de updated
     */
    @JsonIgnore
     ...
     * @return UpdateSnatRuleRequest with credentials.
     */
    @Override
    public UpdateSnatRuleRequest withRequestCredentials(BceCredentials credentials) {
