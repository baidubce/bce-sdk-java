...
public class GetMediaSourceDownloadRequest extends AbstractBceRequest {
    ...
    public GetMediaSourceDownloadRequest withMediaId(String mediaId) {
        this.mediaId = mediaId;
        return this;
    }

    public GetMediaSourceDownloadRequest withExpiredInSeconds(long expiredInSeconds) {
        this.expiredInSeconds = expiredInSeconds;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GetMediaSourceDownloadRequest { \n");
        sb.append("  mediaId = ").append(mediaId).append("\n");
        sb.append("  expiredInSeconds = ").append(expiredInSeconds).append("\n");
        sb.append("}\n");
        return sb.toString();
    }
