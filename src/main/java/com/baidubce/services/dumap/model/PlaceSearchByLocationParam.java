...
/**
 * Represent the request parameters of circular area search query.
 */
@Data
@Builder
public class PlaceSearchByLocationParam {
    ...
    /**
     * Central point of the circular area to be searched
     */
    private String location;

    /**
     * Radius of circular area to be searched
     */
    private String radius;

    /**
     * Whether strictly limit the recall result within the searched radius or not
     */
