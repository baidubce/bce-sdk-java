...
/**
 * Represent the request parameters of administrative area search query.
 */
@Data
@Builder
public class PlaceSearchByRegionParam {
    ...
    /**
     * Administrative region to be searched
     */
    private String region;

    /**
     * Whether strictly limit the recall result in the searched region or not
     */
