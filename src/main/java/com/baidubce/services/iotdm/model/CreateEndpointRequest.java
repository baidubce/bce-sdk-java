...
public class CreateEndpointRequest extends AbstractBceRequest {
    ...
    public void setNewHub(String newHub) {
        this.newHub = newHub;
    }
    ...
    public CreateEndpointRequest withNewHub(String newHub) {
        this.setNewHub(newHub);
        return this;
    }

    @Override
    public CreateEndpointRequest withRequestCredentials(BceCredentials credentials) {
