...
public class GetStatPvRequest extends AbstractBceRequest {
     ...
     */
    public GetStatPvRequest withDomain(String domain) {
        setDomain(domain);
        return this;
    }
     ...
     * @return returns this object
     */
    public GetStatPvRequest withEndTime(Date endTime) {
        setEndTime(endTime);
        return this;
    }
     ...
     * @return returns this object
     */
    public GetStatPvRequest withStartTime(Date startTime) {
     ...
     * @return returns this object
     */
    public GetStatPvRequest withPeriod(Integer period) {
        setPeriod(period);
        return this;
    }
     ...
     */
    @Override
    public GetStatPvRequest withRequestCredentials(BceCredentials credentials) {
