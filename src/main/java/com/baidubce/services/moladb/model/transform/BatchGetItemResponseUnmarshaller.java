...
public class BatchGetItemResponseUnmarshaller implements
    ...
    public BatchGetItemResponseUnmarshaller(AbstractBceResponse response) {
        result = (BatchGetItemResponse) response;
    }
    ...
    public BatchGetItemResponse unmarshall(InputStream stream) throws Exception {
        ...
        JsonNode respObj = jsonObj.get(MolaDbConstants.JSON_RESPONSES);
        JsonNode unprocessObj = jsonObj.get(MolaDbConstants.JSON_UNPROCESSED_ITEMS);
