...
/**
 * the detail info of prepay share bills
 */
@Data
public class PrepayShareBillResponse extends AbstractBceResponse {
     ...
     */
    List<PrepayShareBill> bills = new ArrayList<PrepayShareBill>();
