...
public class GetDocumentImagesRequest extends AbstractBceRequest {
     ...
     */
    public GetDocumentImagesRequest withRequestCredentials(BceCredentials credentials) {
