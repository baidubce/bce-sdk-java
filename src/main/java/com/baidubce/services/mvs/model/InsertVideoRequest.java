...
public class InsertVideoRequest extends AbstractBceRequest {
    ...
    public static class Builder {
        ...
        public InsertVideoRequest build() {
            InsertVideoRequest insertVideoRequest = new InsertVideoRequest();
            insertVideoRequest.setSource(this.source);
            insertVideoRequest.setNotification(this.notification);
            insertVideoRequest.setDescription(this.description);
