...
public class DeviceMarkListResponse extends AbstractBceResponse implements Serializable {

    private static final long serialVersionUID = -62001972372143996L;

    private Collection<DeviceListResponse> data;
    ...
    public Collection<DeviceListResponse> getData() {
        return data;
    }

    public void setData(Collection<DeviceListResponse> data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        DeviceMarkListResponse that = (DeviceMarkListResponse) o;
