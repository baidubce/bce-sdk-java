...
/**
 * The response for appBlb ipGroup.
 */
public class AppIgResponse extends AbstractBceResponse {
     ...
     */
    private List<AppBackendPolicyResponse> backendPolicyList;

    public List<AppBackendPolicyResponse> getBackendPolicyList() {
        return backendPolicyList;
    }
