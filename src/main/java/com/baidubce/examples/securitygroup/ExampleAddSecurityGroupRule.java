...
public class ExampleAddSecurityGroupRule {
    public static void main(String[] args) {
        ...
        // securityGroupRuleOperateRequest.setSgVersion(2L); // 可选，安全组版本号，用于版本控制
        ...
        securityGroupRuleModel.setDirection("egress"); // 规则的方向
        securityGroupRuleModel.setProtocol("tcp"); // 规则协议
        securityGroupRuleModel.setPortRange("107"); // 规则端口范围
