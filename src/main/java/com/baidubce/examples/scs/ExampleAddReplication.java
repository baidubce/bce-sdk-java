...
public class ExampleAddReplication {
    public static void main(String[] args) {
        ...
        ScsReplication slave3Replication = new ScsReplication();
        slave3Replication.setAvailabilityZone(ZONE_NAME);
        slave3Replication.setSubnetId(SUBNET_ID);
        slave3Replication.setIsMaster(0);
        replications.add(slave3Replication);
        request.setReplicationInfo(replications);

        ScsOrderResponse response = client.addReplication(request);
