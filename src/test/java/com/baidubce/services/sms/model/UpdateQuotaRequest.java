...
public class UpdateQuotaRequest extends SmsRequest {
    /**
     * The max count of sending message a day
     */
    private Integer maxSendPerDay;
    /**
     * The max count of receiving message a day
     */
    ...
    public UpdateQuotaRequest(Integer maxSendPerDay, Integer maxReceivePerPhoneNumberDay) {
    ...
    public String toString() {
        return "UpdateQuotaRequest [maxSendPerDay=" + maxSendPerDay + ", maxReceivePerPhoneNumberDay="
                + maxReceivePerPhoneNumberDay + "]";
    }
