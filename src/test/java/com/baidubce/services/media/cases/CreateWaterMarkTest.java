...
public class CreateWaterMarkTest extends AbstractMediaTest {
    ...
    @Test
    public void testCreateWaterMarkDxDy() {
        String bucket = SOURCE_BUCKET;
        String key = SOURCE_LOGO;
        String horizontalAlignment = "center";
        String verticalAlignment = "center";
        ...
        String dy = "0.2";
        CreateWaterMarkResponse response =  mediaClient.createWaterMark(bucket,
                key, horizontalAlignment, verticalAlignment, dx, dy);
        watermarkId = response.getWatermarkId();
        checkWaterMarkExist(watermarkId, true); 
        GetWaterMarkResponse res = mediaClient.getWaterMark(watermarkId); 
        assertEquals("center", res.getHorizontalAlignment());
        assertEquals("center", res.getVerticalAlignment());
        assertEquals("0.1", res.getDx());
        assertEquals("0.2", res.getDy());
    }

    @Test
    public void testCreateWaterMarkDxDyWidthHeight() {
        String bucket = SOURCE_BUCKET;
        String key = SOURCE_LOGO;
        String horizontalAlignment = "center";
        String verticalAlignment = "center";
        ...
        String height = "0.11";
        CreateWaterMarkResponse response =  mediaClient.createWaterMark(bucket,
                key, horizontalAlignment, verticalAlignment, dx, dy, width, height);
        watermarkId = response.getWatermarkId();
        checkWaterMarkExist(watermarkId, true); 
        GetWaterMarkResponse res = mediaClient.getWaterMark(watermarkId); 
        assertEquals("center", res.getHorizontalAlignment());
        ...
        assertEquals("0.1", res.getDx());
        assertEquals("0.2", res.getDy());
        assertEquals("0.15", res.getWidth());
        assertEquals("0.11", res.getHeight());
    }

    @Test
    public void testCreateWaterMarkDxDyWidthHeightTimeline() {
        String bucket = SOURCE_BUCKET;
        String key = SOURCE_LOGO;
        String horizontalAlignment = "center";
        String verticalAlignment = "center";
        ...
        String height = "0.11";
        Integer repeat = 10;
        Timeline timeline = new Timeline().withDurationInMillisecond(10).withStartTimeInMillisecond(15);
        CreateWaterMarkResponse response =  mediaClient.createWaterMark(bucket,
                key, horizontalAlignment, verticalAlignment, dx, dy, width, height, timeline, repeat);
        watermarkId = response.getWatermarkId();
        checkWaterMarkExist(watermarkId, true); 
        GetWaterMarkResponse res = mediaClient.getWaterMark(watermarkId); 
        assertEquals("center", res.getHorizontalAlignment());
        ...
        assertEquals("0.15", res.getWidth());
        assertEquals("0.11", res.getHeight());
        assertEquals(new Integer(15), res.getTimeline().getStartTimeInMillisecond());
        assertEquals(new Integer(10), res.getTimeline().getDurationInMillisecond());
        assertEquals(new Integer(10), res.getRepeated());
    }
}
